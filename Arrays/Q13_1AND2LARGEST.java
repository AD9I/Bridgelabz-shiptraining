...
public class Q13_1AND2LARGEST {
    public static void main(String[] args) {
        ...
        while (number != 0) {
            ...
            // Step 6: Resize the array if necessary
            if (index == maxDigit) {
